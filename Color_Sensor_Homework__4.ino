...
//if statement to compare value read from frequencyOut pin of TCS3200 and compare it to the known value of blueLight. To allow for small discrepancies the value of 10 has been added/subtracted to blueLight
